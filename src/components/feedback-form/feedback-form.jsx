...
const FeedbackForm = () => {
  ...
  return (<form className="reviews__form form" action="#" method="post" onChange={handleChange}>
    ...
    <div className="reviews__button-wrapper">
      ...
      <button className="reviews__submit form__submit button" type="submit" disabled={submit} onChange={handleSubmit}>Submit</button>
    </div>
  </form>);
};
